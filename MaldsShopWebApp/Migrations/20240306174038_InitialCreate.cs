        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCartId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingCarts", x => x.ShippingCartId);
                    table.ForeignKey(
                        name: "FK_ShippingCarts_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShippingCartItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShippingCartId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingCartItems", x => x.ShippingCartItemId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShippingCartItems_ShippingCarts_ShippingCartId",
                        column: x => x.ShippingCartId,
                        principalTable: "ShippingCarts",
                        principalColumn: "ShippingCartId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingCartItems_ShippingCartId",
                table: "ShippingCartItems",
                column: "ShippingCartId");

            migrationBuilder.CreateIndex(
                name: "IX_ShippingCarts_AppUserId",
                table: "ShippingCarts",
                column: "AppUserId",
                unique: true);
        }
